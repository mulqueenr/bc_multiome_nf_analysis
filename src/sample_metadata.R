...
met$wgs=c('DCIS_01'='0', 'DCIS_02'='1', 'DCIS_03'='1', 'IDC_01'='1', 'IDC_02'='1', 'IDC_03'='1', 'IDC_04'='1', 'IDC_16'='0', 'ILC_04'='0', 'IDC_05'='0', 'IDC_06'='1', 'IDC_07'='1', 'IDC_08'='1', 'IDC_09'='1', 'IDC_10'='1', 'IDC_11'='1', 'IDC_12'='0', 'IDC_13'='0', 'IDC_15'='0', 'ILC_01'='0', 'ILC_02'='0', 'ILC_03'='0', 'ILC_05'='0', 'NAT_04'='0', 'NAT_11'='1', 'NAT_14'='1')
met$spatial_atac=c('DCIS_01'='0', 'DCIS_02'='0', 'DCIS_03'='0', 'IDC_01'='1', 'IDC_02'='1', 'IDC_03'='0', 'IDC_04'='0', 'IDC_16'='0', 'ILC_04'='0', 'IDC_05'='0', 'IDC_06'='1', 'IDC_07'='0', 'IDC_08'='0', 'IDC_09'='1', 'IDC_10'='0', 'IDC_11'='0', 'IDC_12'='0', 'IDC_13'='0', 'IDC_15'='0', 'ILC_01'='0', 'ILC_02'='0', 'ILC_03'='0', 'ILC_05'='0', 'NAT_04'='0', 'NAT_11'='0', 'NAT_14'='0')
...
sample_heatmap<-sample_heatmap[c("age","mass","Diagnosis","Diag_MolDiag","sampled_site","multiome","wgs","spatial_atac")]
...
#plot cellcount
dat$epi_celltype<-ifelse(dat$assigned_celltype %in% c("luminal_epithelial","basal_epithelial"),"epi","nonepi")
DF<-as.data.frame(dat@meta.data %>% group_by(sample,epi_celltype) %>% tally())
DF$sample<-factor(DF$sample,levels=names(plot_order))
DF$log_count<-log10(DF$n)
plt1<-ggplot(DF)+geom_bar(aes(x=sample,y=log_count,fill=epi_celltype),stat="identity",position="dodge")+theme_minimal()
...
DF<-as.data.frame(dat@meta.data %>% group_by(sample,assigned_celltype) %>% tally())
DF<-dcast(sample~assigned_celltype,dat=DF,fill=0)
row.names(DF)<-DF$sample;DF<-DF[,2:ncol(DF)]
DF<-DF[,!(colnames(DF) %in% c("luminal_epithelial","basal_epithelial"))]
DF<-proportions(as.matrix(DF), 1) * 100
pdf("sample_celltype_assignment.heatmap.pdf")
plt<-Heatmap(DF)
print(plt)
dev.off()
